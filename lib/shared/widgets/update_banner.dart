...
/// Banner global de actualización. Aparece sobre el contenido cuando hay
/// una versión nueva descargada o disponible, sin depender de la
/// notificación del sistema (que requiere permiso runtime en Android 13+).
///
/// Se alimenta de `UpdateService.instance` (singleton), por lo que no
/// necesita inyección por el árbol de widgets. Se oculta solo cuando no hay
/// actualización, en plataformas no soportadas, o si el usuario lo descarta
/// durante la sesión.
  ...
  Widget build(BuildContext context) {
    ...
    return ListenableBuilder(
      ...
      builder: (context, _) {
        ...
        final visible = status.state == UpdateState.available ||
                  ...
                  if (updater.isBusy)
                    ...
                    IconButton(
                      icon: Icon(Icons.close_rounded,
                          size: 18, color: NexoTheme.textMuted),
