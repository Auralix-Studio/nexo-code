...
abstract final class ClipboardHelper {
  static Future<void> copyAndShow(BuildContext context, String text, {String? label}) async {
  ...
  static void showError(BuildContext context, Object? error, {String? fallback}) {
    final message = error != null ? humanizeError(error) : (fallback ?? 'Ocurrió un error');
    ScaffoldMessenger.of(context).hideCurrentSnackBar();
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Row(
